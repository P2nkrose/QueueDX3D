...
qWeightMapCS::qWeightMapCS()
    : qComputeShader(32, 32, 1, L"shader\\weightmap.fx", "CS_WeightMap")
	, m_WeightMap(nullptr)
...
void qWeightMapCS::CalcGroupNum()
{
