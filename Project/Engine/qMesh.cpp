...
qMesh* qMesh::CreateFromContainer(qFBXLoader& _loader)
{
...
void qMesh::Binding(UINT _iSubset)
{
...
void qMesh::Render(UINT _Subset)
{
	Binding(_Subset);
...
int qMesh::Save(const wstring& _FilePath)
{
	// 상대경로 저장
...
int qMesh::Load(const wstring& _FilePath)
{
	// 읽기모드로 파일열기
	FILE* pFile = nullptr;
