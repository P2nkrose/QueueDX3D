...
wchar_t qPathMgr::g_szSolutionPath[255] = L"";
wchar_t qPathMgr::g_szResPath[255] = L"";
wchar_t qPathMgr::g_szIncPath[255] = L"";
wchar_t qPathMgr::g_szProjPath[255] = L"";
wchar_t qPathMgr::g_szRelativePath[255] = L"";
wchar_t qPathMgr::g_szFile[255] = L"";
wchar_t qPathMgr::g_szExt[50] = L"";
...
wchar_t * qPathMgr::GetResPath()
{
	return g_szResPath;
}

wchar_t * qPathMgr::GetIncludePath()
{
	return g_szIncPath;
}

wchar_t * qPathMgr::GetProjectPath()
{
	return g_szProjPath;
}

wchar_t * qPathMgr::GetFileName(const wchar_t * _strPath)
{
	_wsplitpath_s(_strPath, NULL, 0, NULL, 0, g_szFile, 255, NULL, 0);
	return g_szFile;
}

wchar_t * qPathMgr::GetExt(const wchar_t * _strPath)
{
	_wsplitpath_s(_strPath, NULL, 0, NULL, 0, nullptr, 0, g_szExt, 50);
	return g_szExt;
}

wchar_t * qPathMgr::GetRelativePath(const wchar_t * _pFullPath)
{
...
wchar_t * qPathMgr::GetSolutionPath()
{
